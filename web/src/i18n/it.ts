...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna TeamHermes",
    updatingHermes: "Aggiornamento di TeamHermes…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin TeamHermes (parità con `hermes plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.teamhermes/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.teamhermes/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.teamhermes/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "TeamHermes Achievements",
      subtitle:
        "Badge TeamHermes da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni TeamHermes in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa TeamHermes di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando TeamHermes rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "TeamHermes sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in TeamHermes Agent ☤",
    },
  },
  kanban: {
