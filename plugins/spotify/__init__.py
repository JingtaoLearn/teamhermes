...
``_check_spotify_available()`` — when the user has not run ``thm auth
spotify``, the tools remain registered (so they appear in ``thm
...
The Spotify auth flow (``thm auth spotify``), CLI plumbing, and docs
