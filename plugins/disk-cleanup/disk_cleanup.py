"""disk_cleanup — ephemeral file cleanup for TeamHermes Agent.
...
Never touches: ~/.teamhermes/logs/ or any system directory.
"""
...
try:
    ...
    def get_hermes_home() -> Path:  # type: ignore[no-redef]
        ...
        return Path(val).resolve() if val else (Path.home() / ".teamhermes").resolve()
