# TeamHermes Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.teamhermes/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.teamhermes/plugins/hermes-achievements/scan_checkpoint.json`.
