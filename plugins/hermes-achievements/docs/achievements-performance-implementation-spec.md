# TeamHermes Achievements Implementation Spec (Detailed)
...
Storage path:
- `~/.teamhermes/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.teamhermes/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.teamhermes/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.teamhermes/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.teamhermes/plugins/hermes-achievements/scan_checkpoint.json` (new)
