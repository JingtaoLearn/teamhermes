...
def check_requirements() -> bool:
    ...
    # thm setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `thm gateway setup` flow for the IRC platform.
    ...
    print_info("Restart the gateway for changes to take effect: thm gateway restart")
