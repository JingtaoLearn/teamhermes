"""
Microsoft Teams platform adapter for TeamHermes Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "TeamHermes"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"TeamHermes\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.teamhermes/.env")
