"""ntfy platform adapter (TeamHermes plugin).
...
a TeamHermes dependency.

This adapter ships as a TeamHermes platform plugin under
``plugins/platforms/ntfy/``. The TeamHermes plugin loader scans the
...
async def _standalone_send(
    ...
    *,
    ...
    ``thm cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a TeamHermes dependency",
