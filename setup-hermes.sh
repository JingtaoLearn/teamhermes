...
# 5. Symlinks the 'thm' CLI command into a user-facing bin dir
...
echo ""
echo -e "${CYAN}⚕ TeamHermes Agent Setup${NC}"
echo ""
...
if is_termux; then
    ...
    if [ -n "$UV_CMD" ]; then
        ...
        _uv_log="$(mktemp 2>/dev/null || echo "/tmp/thm-uv-install.$$.log")"
...
# ============================================================================
# PATH setup — symlink thm into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up thm command..."

HERMES_BIN="$SCRIPT_DIR/venv/bin/thm"
COMMAND_LINK_DIR="$(get_command_link_dir)"
COMMAND_LINK_DISPLAY_DIR="$(get_command_link_display_dir)"
mkdir -p "$COMMAND_LINK_DIR"
ln -sf "$HERMES_BIN" "$COMMAND_LINK_DIR/thm"
echo -e "${GREEN}✓${NC} Symlinked thm → $COMMAND_LINK_DISPLAY_DIR/thm"
...
# ============================================================================
# Seed bundled skills into ~/.teamhermes/skills/
# ============================================================================

HERMES_SKILLS_DIR="${HERMES_HOME:-$HOME/.teamhermes}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.teamhermes/skills/ ..."
...
echo "Other commands:"
echo "  thm status        # Check configuration"
if is_termux; then
    echo "  thm gateway       # Run gateway in foreground"
else
    echo "  thm gateway install # Install gateway service (messaging + cron)"
fi
echo "  thm cron list     # View scheduled jobs"
echo "  thm doctor        # Diagnose issues"
echo ""
