"""Windows UTF-8 bootstrap for TeamHermes entry points.
...
should be imported at the very top of every TeamHermes entry point
(``thm``, ``hermes-agent``, ``hermes-acp``, ``python -m gateway.run``,
