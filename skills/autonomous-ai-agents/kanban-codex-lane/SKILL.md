...
description: Use when a TeamHermes Kanban worker wants to run Codex CLI as an isolated implementation lane while TeamHermes keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
