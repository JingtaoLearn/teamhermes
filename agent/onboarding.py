...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``th claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``th claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "run `th claw cleanup` (renames it to ~/.openclaw.pre-migration — "
