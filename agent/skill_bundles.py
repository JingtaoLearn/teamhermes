...
Storage
-------
Bundles live in ``~/.teamhermes/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``thm bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `thm bundles` CLI subcommand.
# ---------------------------------------------------------------------------
