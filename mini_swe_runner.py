#!/usr/bin/env python3
"""
SWE Runner with TeamHermes Trajectory Format

A runner that uses TeamHermes-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the TeamHermes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses TeamHermes-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in TeamHermes format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches TeamHermes-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using TeamHermes-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with TeamHermes Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses TeamHermes-Agent's built-in execution environments
    and outputs trajectories in TeamHermes-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to TeamHermes trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to TeamHermes trajectory format
...
def main(
    ...
    """
    Run SWE tasks with TeamHermes trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with TeamHermes Trajectory Format")
    print("=" * 60)
