...
The Azure SDK reads the `AZURE_*` env vars directly. TeamHermes never inspects them other than to report which sources are present in `hermes doctor` output.
