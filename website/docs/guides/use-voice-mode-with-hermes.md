---
sidebar_position: 8
title: "Use Voice Mode with TeamHermes"
description: "A practical guide to setting up and using TeamHermes voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with TeamHermes
...
- you want TeamHermes sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in TeamHermes.
...
## Step 1: make sure normal TeamHermes works first
...
TeamHermes supports both local and cloud speech stacks.
...
4. TeamHermes transcribes and responds
...
- asking TeamHermes to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full TeamHermes loop.

## Tuning CLI behavior

### Silence threshold

If TeamHermes starts/stops too aggressively, tune:
...
TeamHermes stays a normal chat bot, but can speak replies.
...
- you want TeamHermes to function like a portable research or ops assistant
...
TeamHermes joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- TeamHermes detects speech boundaries
- transcripts are posted in the associated text channel
- TeamHermes responds in text and audio
...
1. get text TeamHermes working
2. install `teamhermes[voice]`
