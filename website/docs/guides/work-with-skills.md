...
thm  skills install official/research/arxiv
...
thm  skills config gif-search

# View all skill config
thm  config get skills.config
```
...
```bash
thm  chat -q "/my-skill help me with the thing"
```
