...
- In the TUI, `/sessions` shows live sessions in the current TUI process. Use `/resume [name]` or `th --tui --resume <id-or-title>` for saved or closed transcripts.
