...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/research/qmd` |
...
TeamHermes Agent via the native MCP client. This is the preferred
...
Then configure TeamHermes Agent to connect via HTTP:
