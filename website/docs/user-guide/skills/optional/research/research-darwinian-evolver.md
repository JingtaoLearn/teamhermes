...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), TeamHermes Agent |
| License | MIT |
...
import upstream classes into TeamHermes itself.
...
```bash
mkdir -p ~/.teamhermes/cache/darwinian-evolver && cd ~/.teamhermes/cache/darwinian-evolver
...
```bash
cd ~/.teamhermes/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.teamhermes/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.teamhermes/skills/research/darwinian-evolver
DE_DIR=~/.teamhermes/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside TeamHermes core.
   Custom driver scripts under `~/.teamhermes/skills/...` are user-side and fine.
