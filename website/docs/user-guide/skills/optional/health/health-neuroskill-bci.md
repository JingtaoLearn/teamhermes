...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/health/neuroskill-bci` |
...
Connect TeamHermes to a running [NeuroSkill](https://neuroskill.com/) instance to read
