...
- User wants **TeamHermes itself to drive a browser** → use TeamHermes' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
