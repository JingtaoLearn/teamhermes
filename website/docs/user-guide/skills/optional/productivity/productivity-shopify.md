...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"TeamHermes","productType":"Apparel","tags":["test"]}}'
```
