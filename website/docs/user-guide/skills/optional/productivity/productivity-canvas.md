...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/productivity/canvas` |
...
4. Name the token (e.g., "TeamHermes Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.teamhermes/.env`:
