...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), TeamHermes Agent |
| License | MIT |
...
```
SCRIPT=~/.teamhermes/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.teamhermes/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
