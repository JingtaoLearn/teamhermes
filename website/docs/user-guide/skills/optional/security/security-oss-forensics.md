...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.teamhermes/skills/security/oss-forensics/`
