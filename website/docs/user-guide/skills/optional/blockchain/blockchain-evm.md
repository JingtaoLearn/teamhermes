...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), TeamHermes Agent |
| License | MIT |
...
Helper script path: `~/.teamhermes/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.teamhermes/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.teamhermes/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.teamhermes/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
