...
| | |
|---|---|
| Source | Optional — install with `thm skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), TeamHermes Agent |
| License | MIT |
...
The script reads `~/.teamhermes/.env` for two optional defaults:
...
Helper script: `~/.teamhermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.teamhermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.teamhermes/.env`.
...
```bash
python3 ~/.teamhermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.teamhermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
