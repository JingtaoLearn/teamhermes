...
## TeamHermes Agent Integration

This skill is designed for the TeamHermes agent. It uses TeamHermes tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other TeamHermes skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.teamhermes/plans/` | `skill_view("plan")` |
