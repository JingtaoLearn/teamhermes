...
```python
import sys
sys.path.insert(0, "/home/teknium/.teamhermes/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.teamhermes/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — TeamHermes installs package this)
