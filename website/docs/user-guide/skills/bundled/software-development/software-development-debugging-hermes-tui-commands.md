...
# Debugging TeamHermes Tui Commands

Debug TeamHermes TUI slash commands: Python, gateway, Ink UI.
...
| Tags | `debugging`, `teamhermes`, `tui`, `slash-commands`, `typescript`, `python` |
...
4. Execute the command and confirm:
   ...
   - Any persisted config updates correctly (`read_file ~/.teamhermes/config.yaml`)
