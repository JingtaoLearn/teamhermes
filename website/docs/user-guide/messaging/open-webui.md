...
flowchart LR
    ...
    B["teamthm<br/>gateway API server<br/>port 8642"]
...
Go to **http://localhost:3000**. Create your admin account (the first user becomes admin). You should see your agent in the model dropdown (named after your profile, or **teamthm** for the default profile). Start chatting!
...
Your agent model should now appear in the model dropdown (named after your profile, or **teamthm** for the default profile).
...
2. Edit your teamthm connection
...
- **Check model listing**: `curl -H "Authorization: Bearer your-secret-key" http://localhost:8642/v1/models` should return a list with `teamthm`
