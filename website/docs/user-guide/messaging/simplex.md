...
> Run `thm  gateway setup` and pick **SimpleX** for a guided walk-through.
...
2. Use **DM pairing** — send any message to the bot and it will reply with a pairing code. Enter that code via `thm  gateway pair`.
