...
> Run `th gateway setup` and pick **Google Chat** for a guided walk-through.
...
- Delivery type: **Pull**
- Message retention: **7 days** (so backlog survives a th restart)
...
3. Check `th gateway` logs for `[GoogleChat] Connected`. If you see
