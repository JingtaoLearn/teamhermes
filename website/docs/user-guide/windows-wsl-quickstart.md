...
### Desktop shortcut for opening TeamHermes quickly

If you just want a double-click launcher for an interactive TeamHermes shell, create
...
- **Custom icon:** open **Properties -> Change Icon** and point it at an `.ico`
  file, such as the TeamHermes favicon from the repo.
