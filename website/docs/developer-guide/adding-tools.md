...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to TeamHermes Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in TeamHermes tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying TeamHermes core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a TeamHermes Plugin](/guides/build-a-hermes-plugin)
...
- [ ] Tested with `thm chat -q "Use the weather tool for London"`
