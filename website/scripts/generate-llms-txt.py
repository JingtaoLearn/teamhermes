#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the TeamHermes docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use TeamHermes as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with TeamHermes", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with TeamHermes", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with TeamHermes", None),
        ("guides/build-a-hermes-plugin", "Build a TeamHermes Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with TeamHermes"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# TeamHermes Agent — Full Documentation\n",
        (
            "This file is the entire TeamHermes Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using TeamHermes, Features, Messaging, Integrations, Guides, "
