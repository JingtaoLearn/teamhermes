...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.teamhermes/\.env|\~/\.teamhermes/\.env', "hermes_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.teamhermes/(config\.yaml|SOUL\.md)', "hermes_config_mod", "strict"),
