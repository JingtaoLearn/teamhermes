...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/JingtaoLearn/teamhermes/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:JingtaoLearn/teamhermes.git"
REPO_URL_HTTPS="https://github.com/JingtaoLearn/teamhermes.git"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "                   default (non-root):  ~/.teamhermes/thm-agent"
...
# Decide where the repo checkout + venv live, and where the `thm` command
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/JingtaoLearn/teamhermes/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
