#!/usr/bin/env python3
"""Build the TeamHermes Skills Index — a centralized JSON catalog of all skills.
...
`thm skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building TeamHermes Skills Index...", flush=True)
