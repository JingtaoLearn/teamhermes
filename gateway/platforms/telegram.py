...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `th update` or `--replace` handoffs)
        ...
        message = (
            ...
            "with this token, then restart the gateway with 'th gateway restart'."
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        CLI ``th model`` picker via the shared ``group_providers`` fold,
