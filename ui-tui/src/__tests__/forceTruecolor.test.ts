...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless TeamHermes truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit TeamHermes truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
