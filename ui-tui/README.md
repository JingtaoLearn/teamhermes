...
React + Ink terminal UI for TeamHermes. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
- Input history is stored in `~/.teamhermes/.teamhermes_history` or under `HERMES_HOME`.
