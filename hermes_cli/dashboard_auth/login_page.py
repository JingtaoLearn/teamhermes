...
<title>Sign in — TeamHermes Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the TeamHermes Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — TeamHermes Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
