...
Usage:
    th pairing list              # Show all pending + approved users
    th pairing approve <platform> <code>  # Approve a pairing code
    th pairing revoke <platform> <user_id> # Revoke user access
    th pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle th pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: th pairing {list|approve|revoke|clear-pending}")
        print("Run 'th pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'th pairing list' to see pending codes.\n")
