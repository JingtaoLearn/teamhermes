...
TIPS = [
    ...
    "hermes mcp serve runs TeamHermes itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire TeamHermes home directory.",
    ...
    "hermes gateway install sets up TeamHermes as a system service (systemd/launchd).",
    ...
    "hermes acp runs TeamHermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard --tui embeds the full TeamHermes TUI in your browser via xterm.js and a WebSocket PTY.',
