...
Used by ``thm profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the TeamHermes Agent kanban board.
...
Rules:
  ...
  - Never write "TeamHermes Agent profile" or other meta-narration.
