"""TeamHermes CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.teamhermes/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "TeamHermes Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ TeamHermes "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "TeamHermes Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.teamhermes/skins/
...
Drop a YAML file in ``~/.teamhermes/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic TeamHermes — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "TeamHermes Agent",
            "welcome": "Welcome to TeamHermes Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ TeamHermes ",
            "prompt_symbol": "❯",
