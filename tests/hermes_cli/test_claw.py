...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.teamhermes/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.teamhermes/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.teamhermes/migration/openclaw/20250312T120000",
        }
