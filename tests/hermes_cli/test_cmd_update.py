...
class TestCmdUpdateBranchFlag:
    """``th update --branch <name>`` targets the requested branch.
...
class TestCmdUpdateCheckBranchFlag:
    """``th update --check --branch <name>`` honors the branch override.
...
class TestCmdUpdateZipBranchRefusal:
    """``th update --branch=<non-main>`` must refuse on the ZIP fallback path.
