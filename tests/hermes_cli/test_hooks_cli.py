"""Tests for the ``th hooks`` CLI subcommand."""
...
class TestHooksDoctor:
    ...
    def test_unallowlisted_script_is_not_executed(self, tmp_path):
        """Regression for M4: `th hooks doctor` used to run every
