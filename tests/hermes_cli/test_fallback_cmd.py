"""Tests for `th fallback` — chain reading, add/remove/clear, legacy migration."""
...
def _write_config(home: Path, data: dict) -> None:
    config_path = home / ".teamhermes" / "config.yaml"
...
class TestArgparseWiring:
    """Verify `th fallback` is wired into main.py's argparse tree.
