...
def test_kanban_tools_hidden_without_env_var(monkeypatch, tmp_path):
    """Normal `thm chat` sessions (no HERMES_KANBAN_TASK) must have
...
# restarting TeamHermes. These tests pin that ``board=<slug>`` argument
...
def multi_board_env(monkeypatch, tmp_path):
    """Isolated TeamHermes home with two distinct kanban boards seeded.
