...
Run from the PR worktree:
    ...
    cd ~/.teamhermes/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.teamhermes/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.teamhermes/hermes-agent
