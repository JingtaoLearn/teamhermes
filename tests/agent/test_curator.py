...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    """th curator unpin must refuse bundled/hub skills too (matches pin)."""
...
# `th model` → auxiliary picker, the dashboard Models tab, and the full
